...
exports.InteractiveFormatter = void 0;
class InteractiveFormatter {
    constructor(configManager) {
        this.configManager = configManager;
    }
    formatInventoryInteractive(inventory) {
...
`;
    ...
    renderDurabilityBar(current, max) {
        const percentage = (current / max) * 100;
        const durabilityClass = percentage >= 70 ? 'weight-ok' :
...
`;
    ...
    formatCompactInteractive(inventory) {
...
exports.InteractiveFormatter = InteractiveFormatter;
